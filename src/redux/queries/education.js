...
const { reducer: educationReducer, reducerPath: educationName } = educationQuery;

export { educationQuery as default, educationName, educationReducer };

export const { useGetEducationsQuery, useAddEducationMutation, useUpdateEducationMutation, useGetEducationMutation, useDeleteEducationMutation } = educationQuery;
