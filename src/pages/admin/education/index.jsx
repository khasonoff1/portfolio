...
import { Button, Flex, Form, Input, Modal, Pagination, Select, Space, Table } from "antd";

import { UserAddOutlined, SaveOutlined, EditOutlined, DeleteOutlined } from "@ant-design/icons";
import Search from "antd/es/input/Search";
import { LIMIT } from "../../../constants";
import { useAddEducationMutation, useDeleteEducationMutation, useGetEducationMutation, useGetEducationsQuery, useUpdateEducationMutation } from "../../../redux/queries/education";
...
const EducationPage = () => {
    ...
    const { data: { educations, total } = { educations: [], total: 0 }, isFetching, refetch } = useGetEducationsQuery({ page, search });
