...
import { addSkill, deleteSkill, editSkill, getSkill, getSkills, skillName } from "../../../redux/slices/skills";
...
const SkillsPage = () => {
    ...
    const { skills, loading, total, isModalLoading } = useSelector((state) => state[skillName]);
