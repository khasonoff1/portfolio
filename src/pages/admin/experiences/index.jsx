...
import { Button, Flex, Form, Input, Modal, Pagination, Space, Table } from "antd";
import { UserAddOutlined, SaveOutlined, EditOutlined, DeleteOutlined } from "@ant-design/icons";
import Search from "antd/es/input/Search";
import { LIMIT } from "../../../constants";
import { useAddExperienceMutation, useDeleteExperienceMutation, useGetExperienceMutation, useGetExperiencesQuery, useUpdateExperienceMutation } from "../../../redux/queries/experience";
...
const ExperiencesPage = () => {
    ...
    const { data: { experiences, total } = { educations: [], total: 0 }, isFetching, refetch } = useGetExperiencesQuery({ page, search });
